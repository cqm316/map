      ...
      select: function(){
        ...
        ,events = function(reElem, disabled, isSearch){
          ...
          dds.on('click', function () {
              ...
              select.val(value).change().removeClass('layui-form-danger'), input.val(othis.text());
        ...
        selects.each(function(index, select){
          ...
          var reElem = $(['<div class="layui-unselect ' + CLASS + (disabled ? ' layui-select-disabled' : '') + '">'
            , '<div class="' + TITLE + '"><input type="text" placeholder="' + (select.options && select.options.length > 0 && select.options[0].innerHTML ? select.options[0].innerHTML : TIPS) + '" value="' + (value ? selected.html() : '') + '" ' + (isSearch ? '' : 'readonly') + ' class="layui-input layui-unselect' + (disabled ? (' ' + DISABLED) : '') + '">'
